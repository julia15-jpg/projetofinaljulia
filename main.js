function getProjects() {
  const urlGitHub = "https://github.com/julia15-jpg?tab=repositories"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/julia15-jpg?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
